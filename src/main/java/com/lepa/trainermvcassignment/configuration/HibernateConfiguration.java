package com.lepa.trainermvcassignment.configuration;
...
@ComponentScan({"com.lepa.trainermvcassignment"})
...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[]{"com.lepa.trainermvcassignment.entities"});
